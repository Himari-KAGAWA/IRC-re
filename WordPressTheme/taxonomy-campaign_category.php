        ...
        <div class="page-campaign__nav category-list">
          <div class="category-list__tabs wow fadeIn">
            <ul class="category-list__items">
              ...
              <?php
              // カテゴリーを取得
              $ride_terms = get_terms('campaign_category', array('hide_empty' => false));

              // カテゴリーをループしてリストアイテムとして表示
              foreach ($ride_terms as $ride_term) :
              ?>
                <li class="category-list__item">
                  <a href="<?php echo esc_url(get_term_link($ride_term, 'campaign_category')); ?>" class="category-list__item-link category category--link <?php if (is_tax('campaign_category') && $ride_term->slug == get_queried_object()->slug) echo 'is-show'; ?>">
                    <?php echo esc_html($ride_term->name); ?>
                  </a>
                </li>
              <?php endforeach; ?>
            </ul>
